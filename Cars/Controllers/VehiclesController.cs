...
namespace Cars.Controllers
{
    public class VehiclesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Year,Make,Model,Qty,VehicleTypeId")] Vehicle vehicle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Year,Make,Model,Qty,VehicleTypeId")] Vehicle vehicle)
        {
            if (ModelState.IsValid)
            {
